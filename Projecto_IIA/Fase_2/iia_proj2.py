...
for i in range(0,100):
    jogo1 = jogaRastros11(ganhaBasilio,nigger)
    #print(str(jogo1))
    #mostraJogo(jogo1[0])
    #mostraJogo(jogo1[0], verbose = True)
    if jogo1[1] == 1:
...
# todosJog = [bacoco, obtusoSW, obtusoNE, arlivre, basilio,ganhaBasilio,ze,nigger]
# campeonato = jogaRastrosNN(todosJog, todosJog, nsec=10)
# faz_campeonato([ganhaBasilio,nigger,nigger,nigger,nigger,nigger,nigger,nigger])
